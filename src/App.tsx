    ...
    return (
      <div key={index} className={`msg ` + index}>
        <div className="msgTop">
          <span className="msgAuthor">
            {item.author == socket.id ? "You" : "Not You"}
          </span>
  ...
  return (
    <div className="App">
      <div className="messenger">
        ...
        <p>
          Your ID:{" "}
          <span id="user_id" onClick={(e) => copyToClipboard(e)}>
            {User_id}
          </span>
        </p>
        <p>
          Your room:{" "}
          <span id="current_room" onClick={(e) => copyToClipboard(e)}>
            {CurrentRoom}
          </span>
        </p>
      ...
      <div className="field">
        ...
        <div className="choose">
          <button onClick={(e) => chooseElement(e)} id="rock_button">
            ROCK
          </button>
          <button onClick={(e) => chooseElement(e)} id="paper_button">
            PAPER
          </button>
          <button onClick={(e) => chooseElement(e)} id="scissors_button">
            SCISSORS
          </button>
        </div>
      </div>
